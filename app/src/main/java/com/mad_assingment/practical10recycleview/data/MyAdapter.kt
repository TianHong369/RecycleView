package com.mad_assingment.practical10recycleview.data
...
import com.mad_assingment.practical10recycleview.R

class MyAdapter(private val productList: List<Product>) :
